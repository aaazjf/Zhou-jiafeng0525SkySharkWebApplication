<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="QueryStat.aspx.cs" Inherits="Zhou_jiafeng0525SkySharkWebApplication.LOB.QueryStat" %>
        ...
        <asp:Menu ID="Menu1" runat="server" BackColor="#F7F6F3" DynamicHorizontalOffset="2" Font-Names="Verdana" Font-Size="0.8em" ForeColor="#7C6F57" Orientation="Horizontal" StaticSubMenuIndent="10px">
         ...
         <div class="tabContents">
            <table>
                <tr>
                    <td colspan="2">
                        <asp:Label ID="Label1" runat="server" Text="Enquire about the status of flights and tickets"></asp:Label></td>
                    <td></td>
                 ...
                 <WizardSteps>
                     ...
                     <asp:WizardStep ID="WizardStep2" runat="server" Title="Query Tickets Status">
                         ...
                         <table>
                             <tr>
                                 <td colspan="2">
                                     <asp:Label ID="Label6" runat="server" Text="Query Tickets Status"></asp:Label></td>
                                 <td></td>
                             
                             </tr>
                             <tr>
                                 <td></td>
                                 <td><asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="~/ChangePassword.aspx">Change password</asp:HyperLink></td>
                    <td><asp:HyperLink ID="HyperLink4" runat="server" NavigateUrl="~/Logoff.aspx">Logoff</asp:HyperLink></td>
                             </tr>
                             <tr>
                                 <td>
